...
public class Mongodb {
  ...
  void run() {
    String connectionString =
        String.format(
            "mongodb+srv://%s:%s@%s.mongodb.net/?retryWrites=true&w=majority",
    ...
    //        insertOneDocument(client, DB_NAME, COLLECTION_NAME, new Document().append("name",
    // "bob").append("town", "da bucket"));
